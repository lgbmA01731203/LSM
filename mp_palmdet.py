...
class MPPalmDet:
    def __init__(self, modelPath, nmsThreshold=0.3, scoreThreshold=0.5, topK=5000, backendId=0, targetId=0):
        ...
        try:
            ...
            print(f"[MPPalmDet] Successfully loaded model on GPU: {self.model_path}")
        except Exception as e:
            # Fall back to CPU
            print(f"[MPPalmDet] GPU loading failed ({e}). Falling back to CPU.")
    ...
    def setBackendAndTarget(self, backendId, targetId):
        # Kept for compatibility with demo.py but no-op
        self.backend_id = backendId
        self.target_id = targetId
